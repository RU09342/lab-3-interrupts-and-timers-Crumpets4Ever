...
//LED Junk
    ...
    P2DIR |=   LED2;                             //sets the LED of pin 4 to output
    P2OUT &= ~(LED2);                          //sets output high
